  ...
  const body = html`
    ...
    <div class="detail-head">
      ...
      <span class="head-actions">
        ...
        <a class="btn" href="/admin/legislation/${matter.id}/draft" title="Structured drafting, validation and the provision outline">Draft text</a>
        <a class="btn" href="/admin/legislation/${matter.id}/compare" title="Compare versions, or this measure against current law">Comparative print</a>
